...
// +-------------------------------------------------+
// $Id: config.inc.php,v 1.250.2.28.2.9.2.10.2.45 2026/03/16 11:10:15 gneveu Exp $

// fichier de configuration générale

$pmb_version = "</b>8.1.0</b>";
$pmb_version_brut = "8.1.0";
$pmb_version_patch = "6";
$pmb_version_database_as_it_should_be = "v6.02";
$pmb_subversion_database_as_it_shouldbe = "19";
...
define('IMPORT_EXPORT_AUTH'			, 67108864);
